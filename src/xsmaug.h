...
#define LOG_FILE	LOG_DIR "xsmaug.log"	  /* For talking in logged rooms */
#define NOHELP_FILE	LOG_DIR "nohelp.log"   /* For tracking help
...
#define WIZLIST_FILE	SYSTEM_DIR "wiz.dat"	  /* Wizlist		 */
...
#define USAGE_FILE	LOG_DIR "usage.log"    /* How many people are on 
