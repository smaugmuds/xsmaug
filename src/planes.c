...
void
do_plist (CHAR_DATA * ch, const char *argument)
{
  PLANE_DATA *p;
...
void
do_pstat (CHAR_DATA * ch, const char *argument)
{
  PLANE_DATA *p;
...
void
do_pset (CHAR_DATA * ch, const char *argument)
{
  PLANE_DATA *p;
  char arg[MAX_INPUT_LENGTH];
