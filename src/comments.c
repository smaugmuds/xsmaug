...
void
comment_remove (CHAR_DATA * victim, NOTE_DATA * pnote)
{
  if (!victim->comments)
    {
...
void
do_comment (CHAR_DATA * ch, const char *argument)
{
...
void
fwrite_comments (CHAR_DATA * ch, FILE * fp)
{
  NOTE_DATA *pnote;
...
void
fread_comment (CHAR_DATA * ch, FILE * fp)
{
  NOTE_DATA *pnote;
