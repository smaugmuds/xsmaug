...
const int CODEPORT = 4700;
const int BUILDPORT = 4600;
const int MAINPORT = 4000;
...
const int ROOM_VNUM_SCHOOL = 10300;
...
const int ROOM_VNUM_TEMPLE = 21001; /* Catacombs || Orig: Primary continent recall 11407 */
const int ROOM_VNUM_ALTAR = 21194;  /* Primary continent death */
const int ROOM_VNUM_ASTRAL_DEATH = 21194; /* Astral Plane, death sends you to Primary continent */
