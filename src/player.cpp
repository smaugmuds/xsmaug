...
CMDF( do_inventory )
{
   ...
   ch->print( "\r\n&GItems with a &W*&G after them have other items stored inside.\r\n" );
}
...
const string output_person( char_data * ch, char_data * player )
{
   ...
   /*
    * Modified by Tarl 24 April 02 to display an invis level on the XSMAUG interface. 
    */
