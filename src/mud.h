...
#include "mud_cfg.h"  /* Contains definitions specific to your mud - will not be covered by patches. Samson 3-14-04 */
 ...
 */
#define WORLD_DIR		RUNDIR "realm/"
#define AREA_CONVERT_DIR	RUNDIR "areaconvert/"   /* Directory for manually converting areas */
#define MAP_DIR			RUNDIR "maps/" /* Overland maps */
...
#define SHOP_DIR 		RUNDIR "shops/"  /* Clan/PC shopkeepers - Samson 7-16-00 */
#define DEITY_DIR 		RUNDIR "deity/"   /* Deity data dir      */
#define MOTD_DIR 		RUNDIR "motd/"
#define HOTBOOT_DIR		RUNDIR "hotboot/" /* For storing objects across hotboots */
#define AUC_DIR			RUNDIR "aucvaults/"
#define BOARD_DIR		RUNDIR "boards/"  /* Board directory */
#define COLOR_DIR		RUNDIR "color/"
#define WEB_DIR 		RUNDIR "web/"  /* HTML static files */
#define WEB_ROOMS		WEB_DIR "web/webrooms/" /* HTML Web room files */

#define EXE_FILE	BINDIR	  	PACKAGE
...
#define QUOTE_FILE			"quotes.dat" /* List of fortune strings */
...
#define LOG_FILE	LOGDIR		"xsmaug.log" /* For talking in logged rooms */
#define MOBLOG_FILE	LOGDIR		"moblog.log" /* For mplog messages  */
#define NOHELP_FILE	LOGDIR		"nohelp.log"  /* For tracking missing help entries */
#define MOBDATA_FILE    LOGDIR          "mobdata_dump.log" /* MOB Data Dump File */
#define ROOMDATA_FILE   LOGDIR          "roomdata_dump.log" /* ROOM Data Dump File */
#define OBJDATA_FILE    LOGDIR          "objdata_dump.log" /* OBJ Data Dump File */
...
#define NAMEGEN_FILE	SYSTEM_DIR	"namegen.dat"   /* Used for the name generator */
#define TONGUE_FILE	SYSTEM_DIR	"tongues.dat"   /* Tongue tables    */
#define SOCIAL_FILE	SYSTEM_DIR	"socials.dat"   /* Socials       */
#define COMMAND_FILE	SYSTEM_DIR	"commands.dat"  /* Commands      */
#define HISTORY_FILE    SYSTEM_DIR 	"history.dat"   /* Used in do_history */
#define AUTH_FILE	SYSTEM_DIR	"auth.dat" /* Auth file */
#define RESERVED_LIST	SYSTEM_DIR	"reserved.lst" /* List of reserved names  */
#define RUNE_FILE	SYSTEM_DIR	"runes.dat" /* Treasure runes file */
#define RUNEWORD_FILE	SYSTEM_DIR	"runeword.dat" /* Treasure runeword file */
#define WTYPE_FILE	SYSTEM_DIR	"weapontypes.dat" /* Treasure weapons file */
#define ATYPE_FILE	SYSTEM_DIR	"armortypes.dat" /* Treasure armors file */
#define MAT_FILE	SYSTEM_DIR	"materials.dat" /* Treasure materials file */
...
#define MSSP_FILE	SYSTEM_DIR	"mssp.dat" /* For MSSP */
#define DNS_FILE	SYSTEM_DIR	"dns.dat" /* DNS file */
#define CHANNEL_FILE	SYSTEM_DIR	"channels.dat" /* For channels */
#define HOLIDAY_FILE	SYSTEM_DIR	"holidays.dat" /* Holiday chart */
#define CH_FILE		SYSTEM_DIR	"conn.hst" /* System connections history */
#define WEBWHO_FILE	WEB_DIR		"who.html"  /* HTML Who output file */
#define WEBWIZ_FILE     WEB_DIR		"wiz.html"  /* HTML wizlist file */
#define AREALIST_FILE   WEB_DIR		"areas.html"   /* HTML areas listing */
#define MOTD_FILE       MOTD_DIR	"motd.dat" /* Message Of The Day */
#define IMOTD_FILE      MOTD_DIR	"imotd.dat" /* Immortals Message Of The Day */
#define SPEC_MOTD       MOTD_DIR	"specmotd.dat" /* Special MOTD - cannot be ignored on login */
#define SALES_FILE	AUC_DIR		"sales.dat" /* Data file for auction sales */
#define LANDING_SITE_FILE MAP_DIR	"landing_sites.dat" /* Skiships landing sites */
#define ENTRANCE_FILE	MAP_DIR		"entrances.dat" /* Overland entrances */
#define LANDMARK_FILE	MAP_DIR		"landmarks.dat" /* Overland landmarks */
