...
CMDF( do_basereport )
{
   ch->printf( "&RCodebase revision: %s - %s\r\n", PACKAGE_STRING, PACKAGE_BUGREPORT );
   ch->print( "&YContributors: Samson, Dwip, Whir, Cyberfox, Karangi, Rathian, Cam, Raine, Tarl and Burzumishi.\r\n" );
   ...
   ch->print( "Copies of XSMAUG beginning with 2.4 as of June 27, 2014 include this.\r\n" );
