...
the spouse string so this will work.

This snippet also includes a rings command.  It'll create the rings for
the married couple.  Which you'll have to define in mud.h OBJ_VNUM_DIAMOND_RING
and OBJ_VNUM_WEDDING_BAND to vnums that you might have (of course I created
2 rings for this then added in the marriage code). The rings command would
be the easiest to add in cause of just putting in 2 lines in mud.h...

Even though its a lot easier then the marriage, and divorce code... but it needs
the spouse field (checks to see if they are married). Well enjoy... btw dont
forget to put somewhere in your code to give me credits or if you just pop
in this file...Keep the this header intact.

Add do_rings,  do_divorce and do_marry to mud.h and tables.c - Ntanel StormBlade
*/
