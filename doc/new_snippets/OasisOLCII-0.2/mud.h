...
/* #define REQWHOARG  durn Gorog */
#define SPIRIT_DAMAGE /* Tagith */
...
typedef enum
{
  ...
  AFF_CONTAGIOUS, AFF_VISION, MAX_AFFECTED_BY
} affected_by_types;
...
typedef enum
{
  ...
  ITEM_PROTOTYPE, ITEM_NOLOCATE, ITEM_GROUNDROT, ITEM_SPIRIT, MAX_ITEM_FLAG
} item_extra_flags;
...
#define PCFLAG_GRLOOT		   BV16 /* Tagith */
...
extern	sh_int	gsn_rapture; /* Tagith */
extern	sh_int	gsn_haven;
extern	sh_int	gsn_rake;
extern	sh_int	gsn_spirit_message;
extern	sh_int	gsn_tiger_grace;
extern	sh_int	gsn_open_palm;
extern	sh_int	gsn_cripple;
extern	sh_int	gsn_body_sympathy;
extern	sh_int	gsn_humility;
...
DECLARE_DO_FUN( do_blockexit	); /* Tagith */
...
DECLARE_DO_FUN( do_haven	); /* Tagith, monks */
...
DECLARE_DO_FUN( do_rake		); /* Monks, Tagith */
DECLARE_DO_FUN(	do_rank	        );
DECLARE_DO_FUN( do_rap		);
DECLARE_DO_FUN( do_rapture	); /* Monks, Tagith */
...
DECLARE_DO_FUN( do_spirit_message ); /* Monks, Tagith */
...
DECLARE_SPELL_FUN(	spell_seal_exit		);
...
sh_int	MONK_AC		args( ( CHAR_DATA *ch ) );
sh_int	MONK_DR		args( ( CHAR_DATA *ch ) );
